                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('Fee Structure') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('Fee Structure') }}</h3>
                            </div>
                                        ...
                                        <div class="grid-item">
                                            ...
                                            <select name="academic_year_id" id="academic_year_id"  class="form-control">
                                                ...
                                                @foreach ($academicYears as $option)
                                                    <option value="{{ $option->id }}"  @selected($option->id == old('academic_year_id'))>{{ $option->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="grid-item">
                                            ...
                                            <select name="class_id" id="class_id"  class="form-control">
                                                ...
                                                @foreach ($classes as $item)
                                                    <option value="{{ $item->id }}" @selected($item->id == old('class_id'))>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('class_id')
                                                <div class="text-danger">{{ $message }}</div>
                                        ...
                                        <div class="grid-item">
                                            ...
                                            <select name="fee_head_id" id="fee_head_id"  class="form-control">
                                                ...
                                                @foreach ($feeHeads as $item)
                                                    <option value="{{ $item->id }}" @selected($item->id == old('fee_head_id'))>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('fee_head_id')
                                                <div class="text-danger">{{ $message }}</div>
                                        ...
                                        @foreach ($months_fields as $field_name => $month_name)
                                            <div class="grid-item">
                                                ...
                                                <input type="text" class="form-control" id="{{ $field_name }}"
                                                    name="{{ $field_name }}" value="{{ old($field_name, $defaultFee) }}"
